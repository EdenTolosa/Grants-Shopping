   ...
   <div class="row">
     ...
     <div class="col s12 m6">
          ...
          <div class="input-field col s12">
           ...
           <?php
            ...
            if (isset($_POST['wish'])) {
              ...
              $querywish = "INSERT INTO command(id_produit, quantity, statut, id_user)
              VALUES ('$id_productdb','$quantity','wishlisted', '$idsess')";

            if ($connection->query($querywish) === TRUE) {
                     $_SESSION['item'] += 1;

                     echo "<meta http-equiv='refresh' content='0;url=product.php?id=$id_productdb' />";
                 } else {
                     echo "<h5 class='text-red'>Error: " . $querywish . "</h5><br><br><br>" . $connection->error;
                 }
                 $connection->close();
                 }
                }
       ...
       <div class="center-align">
           ...
           <button type="submit" name="wish" class="btn-large meh button-rounded waves-effect waves-light ">Add to Wishlist</button>
           ...
           <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScCEtxohbhg_IuDhXP3GN8R3Aq2qN9FGcEUyxlmL2WlMyquhg/viewform?embedded=true" width="640" height="408" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
